<template>
  <div class="mood-question-create-page">
    <div class="page-header">
      <h1>➕ Create Mood Question</h1>
        ...
        <div v-if="form.options.length" class="options-list">
          <div v-for="(option, index) in form.options" :key="index" class="option-item">
            ...
            <div class="form-group">
              ...
              <input v-model="option.tagsInput" @input="updateOptionTags(option)" type="text" class="form-input" placeholder="happy, energetic" />
            </div>
          </div>
        </div>
      </div>
...
async function handleSubmit() {
  try {
    ...
    await moodStore.createQuestion(data)
